      ...
      <Swiper navigation autoplay={{ delay: 3000, disableOnInteraction: false }}>
        ...
        <SwiperSlide>
          <div className="swiper_slide">
            ...
            <div className="swiper_slide:desc">
              No need to peel garlic cloves if you have a garlic press. Just pop the whole clove in the hopper, press, and
              then remove the empty peel.
            </div>
          </div>
        </SwiperSlide>
        ...
        <SwiperSlide>
          <div className="swiper_slide">
            ...
            <div className="swiper_slide:desc">
              To prevent quinoa from falling through your fine mesh sieve while rinsing, run the sieve under water first to
              create a barrier between the quinoa and mesh.
            </div>
          </div>
        </SwiperSlide>
        ...
        <SwiperSlide>
          <div className="swiper_slide">
            ...
            <div className="swiper_slide:desc">
              To ensure chicken breasts cook evenly from top to bottom, place the chicken on a cutting board then cover with
              Glad Press’n’ Seal or saran wrap, and then whack it with a rolling pin or meat mallet until the chicken is the
              same thickness.
            </div>
          </div>
        </SwiperSlide>
